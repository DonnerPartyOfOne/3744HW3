...
import cs3744.hw3.HW3Model.HW2Circle;
...
public class HW3View extends BorderPane {
	...
	private TableView<HW2Circle> tv = null;
	...
	public HW3View(Stage s) {
		...
		menuFile.getItems().addAll(fileNew, fileOpen, fileClose, fileSave, separatorOne,  fileQuit);
		...
		tv = new TableView<HW2Circle>();
		sp = new SplitPane();
		tv.setEditable(true);
		
		
		TableColumn<HW2Circle, Double> centerX = new TableColumn<HW2Circle, Double>("X center"); 
		TableColumn<HW2Circle, Double> centerY = new TableColumn<HW2Circle, Double>("Y center"); 
		TableColumn<HW2Circle, Double> radius = new TableColumn<HW2Circle, Double>("Radius"); 
		TableColumn<HW2Circle, Color> color = new TableColumn<HW2Circle, Color>("Color");
		centerX.prefWidthProperty().bind(tv.widthProperty().divide(4));
		centerY.prefWidthProperty().bind(tv.widthProperty().divide(4));
		radius.prefWidthProperty().bind(tv.widthProperty().divide(4));
		color.prefWidthProperty().bind(tv.widthProperty().divide(4));
		
		
		centerX.setCellValueFactory(new PropertyValueFactory<HW2Circle, Double>("centerX"));
		centerY.setCellValueFactory(new PropertyValueFactory<HW2Circle, Double>("centerY"));
		radius.setCellValueFactory(new PropertyValueFactory<HW2Circle, Double>("radius"));
		color.setCellValueFactory(new PropertyValueFactory<HW2Circle, Color>("color"));
		
		centerX.setCellFactory(TextFieldTableCell.forTableColumn(new DoubleStringConverter()));
		centerY.setCellFactory(TextFieldTableCell.forTableColumn(new DoubleStringConverter()));
		radius.setCellFactory(TextFieldTableCell.forTableColumn(new DoubleStringConverter()));
		color.setCellFactory(ColorTableCell<HW2Circle>::new);
		
		tv.getColumns().setAll(centerX, centerY, radius, color);
		

		final ScrollPane sp1 = new ScrollPane(canvas);
		final ScrollPane sp2 = new ScrollPane(tv);
	...
	//THANK YOU BASED http://info.michael-simons.eu/2014/10/27/custom-editor-components-in-javafx-tablecells/
	...
	public TableView<HW2Circle> getTV() {
		return tv;
	}
	 ...
	 */
	public ObjectProperty<ViewState> viewStateProperty() { return viewState; }
	 ...
	 */
	public ViewState getViewState() { return viewState.get(); }
	 ...
	 */
	public void setViewState(ViewState v) { viewState.set(v); }
	 ...
	 */
	public ObjectProperty<ClipboardState> clipboardStateProperty() { return clipboardState; }
	 ...
	 */
	public ClipboardState getClipboardState() { return clipboardState.get(); }
	 ...
	 */
	public void setClipboardState(ClipboardState v) { clipboardState.set(v); }
